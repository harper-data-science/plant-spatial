...
par(mai = c(1,1,1,1))
plot(bdry.spdf, axes = TRUE)
plot(data.Set4.1, add = TRUE, pch = 16)
title(main = "Field 4.1", cex.main = 2, xlab = "Easting",
...
title(main = "Field 4.1 Silt Content", cex.main = 2, xlab = "Easting",
   ylab = "Northing", cex.lab = 1.5)
...
Sand.vgm <- variogram(Sand ~ 1, data.Set4.1, cutoff = 600)
